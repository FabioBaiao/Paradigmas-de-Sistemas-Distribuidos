...
*/
    ...
    public String getExchange(String company) {
        ...
        return responseIsOk(response) ? response.readEntity(String.class);
    }
/*
...
*/
    ...
    public void setCurrentDayClosePrice(String company, Double closePrice) {
        Response response = target.path(company + "/current/close")
                                  .request(MediaType.APPLICATION_JSON)
    ...
    public Data setPreviousDayPrices(String company, Data previousData) {
        Response response = target.path(company + "/previous")
                                  .request(MediaType.APPLICATION_JSON)
